...
<body>
                ...
                <div class="collapse navbar-collapse" id="navbarSupport">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item" back>
                            <a class="nav-link btn btn-primary" href="{{url('myappointment')}}">My Appointment</a>
                        </li>
                        <x-app-layout>
    ...
    <div align="center" style="padding: 50px;">
        <h1 style="padding: 20px; font-size:40px;">My Appointment</h1>
        <table>
            <tr class="bg-primary">
            ...
            <tr align="center">
                ...
                <td><a href="{{url('cancel_appoint', $appoints->id)}}" class="btn btn-danger text-center">Cancel</a>
                </td>
            </tr>
            @endforeach
        </table>
